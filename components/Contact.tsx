...
const LINKS = [
  { word: "GITHUB!",   color: "#FFD700", href: "https://github.com",    label: "GitHub"     },
  { word: "LINKEDIN!", color: "#00D4FF", href: "https://linkedin.com",  label: "LinkedIn"   },
  { word: "EMAIL!",    color: "#FF3333", href: "mailto:hi@example.com", label: "Email"      },
  { word: "TWITTER!",  color: "#FF6B35", href: "https://twitter.com",   label: "Twitter / X" },
];
